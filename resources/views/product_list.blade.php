                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_item">
                                ...
                                <h3> <a href="{{ asset("product") }}">Cervical pillow for airplane
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_item">
                                ...
                                <h3> <a href="{{ asset("product") }}">Geometric striped flower home classy decor</a> </h3>
                                <p>From $5</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_item">
                                ...
                                <h3> <a href="{{ asset("product") }}">Foam filling cotton slow rebound pillows</a> </h3>
                                <p>From $5</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_item">
                                ...
                                <h3> <a href="{{ asset("product") }}">Memory foam filling cotton Slow rebound pillows</a> </h3>
                                <p>From $5</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_item">
                                ...
                                <h3> <a href="{{ asset("product") }}">Sleeping orthopedic sciatica Back Hip Joint Pain relief</a> </h3>
                                <p>From $5</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6">
